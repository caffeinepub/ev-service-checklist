...
export class Backend implements backendInterface {
    ...
    async getRecentChecklists(arg0: bigint): Promise<Array<Checklist>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentChecklists(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveChecklist(arg0: ChecklistInput): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveChecklist(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
